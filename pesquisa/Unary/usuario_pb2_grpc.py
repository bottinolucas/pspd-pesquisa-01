...
class UsuarioServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.BuscarUsuario = channel.unary_unary(
                '/unary.UsuarioService/BuscarUsuario',
...
def add_UsuarioServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'unary.UsuarioService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('unary.UsuarioService', rpc_method_handlers)
